(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var swalProviderToken = new core.InjectionToken('@sweetalert2/ngx-sweetalert2#swalLibraryToken');
    /** @type {?} */
    ...
    var SwalComponent = /** @class */ (function () {
        ...
        SwalComponent.propDecorators = {
            ...
            customContainerClass: [{ type: core.Input }],
        ...
        Object.defineProperty(SwalDirective.prototype, "swal", {
            ...
            function (options) {
                ...
                if (options instanceof SwalComponent) {
                    ...
                    this.swalOptions = {};
                    _a = __read(options, 3), this.swalOptions.title = _a[0], this.swalOptions.text = _a[1], this.swalOptions.type = _a[2];
                }
                else {
                    this.swalOptions = options;
                }
    ...
    var SwalPortalTargets = /** @class */ (function () {
        function SwalPortalTargets() {
            ...
            this.content = {
                 ...
                 * @return {?}
                 */
                function (swal) { return (/** @type {?} */ (swal.getContent().querySelector('#swal2-content'))); }),
                // Empty text that will never be shown but necessary so SweetAlert2 makes the div visible.
                options: { text: ' ' }
            };
            /**
    ...
    exports.ɵc = dismissOnDestroyToken;
    exports.ɵd = SwalPortalDirective;
